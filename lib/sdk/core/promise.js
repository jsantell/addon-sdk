...
getEnvironment.call(this, function ({ require, exports, module, utils }) {

const { defer, resolve, all, reject } = utils.Promise;
...
function getEnvironment (callback) {
  let _Promise, _exports, _module, _require;

  // CommonJS / SDK
  if (typeof(require) === 'function') {
    let { Cu } = require('chrome');
    _Promise = Cu.import('resource://gre/modules/Promise.jsm', {}).Promise;
    _exports = exports;
    _module = module;
    _require = require;
  }
